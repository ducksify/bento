...
os_version              = "12.1"
os_arch                 = "aarch64"
iso_url                 = "https://cdimage.debian.org/debian-cd/current/arm64/iso-cd/debian-12.2.0-arm64-netinst.iso"
iso_checksum            = "file:https://cdimage.debian.org/cdimage/release/12.2.0/arm64/iso-cd/SHA256SUMS"
